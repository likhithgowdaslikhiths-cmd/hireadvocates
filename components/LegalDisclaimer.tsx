...
return ( <div
 ...
 > <div className="bg-white max-w-lg w-full rounded-xl shadow-2xl p-6 animate-fadeIn">
    ...
    <div className="text-sm text-gray-700 space-y-4 leading-relaxed max-h-[300px] overflow-y-auto pr-2">
      ...
      <p>
        This website is provided solely for informational purposes.
        The content available on this website should not be interpreted
        as legal advice or solicitation.
      </p>

      <p>
        By clicking <strong>“AGREE”</strong>, you acknowledge that you
        are accessing this website voluntarily to obtain information
        about legal services and that no solicitation, advertisement,
        or inducement has been made by HireAdvocates.
      </p>

      <p>
        HireAdvocates shall not be responsible for any decisions taken
        by users based solely on the information provided on this website.
